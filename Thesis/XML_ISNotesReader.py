...
# Need to determine which values are needed and on which spans

# # # # Data Structure for this information # # # #
# Markables as a span
# Information Status?
# Mediated type = bridging
# span="word_10..word_11" (Use this to determine where to put the markable info
# Bridged from  (use this to mark as coreferent?
# bridge_type = other   # keep info for reference

# # # # Output format to append to files # # # #
# (coreference)    Info status/-   mediated_type/-   bridge_type/-   (bridge_id)

# OK but it may not be appropriate to do bridging with cluster indeces
# maybe should just do bridged and have column for

# Coref File needs to speak total words in file
#
